...
protocol NewsServiceMostShared {
    func request(from endpoint: NewsApiMostShared) -> AnyPublisher<NewResponse, APIError>
}

struct NewsServiseImpletationShared: NewsServiceMostShared {
